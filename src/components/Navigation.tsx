  ...
  const fetchUserContent = async () => {
    try {
      ...
      if (policiesResponse.ok) {
        ...
        if (policiesData) {
          const userPoliciesList = Object.entries(policiesData)
      ...
      if (servicesResponse.ok) {
        ...
        if (servicesData) {
          const userServicesList = Object.entries(servicesData)
      ...
      if (forumsResponse.ok) {
        ...
        if (forumsData) {
          const userForumsList = Object.entries(forumsData)
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          <div className="flex items-center gap-4">
            <Link href="/newsfeed" className="p-2 text-gray-600 hover:text-gray-900 rounded-lg hover:bg-gray-100">
          ...
          <div className="flex items-center gap-4">
            <Link href="/forums" className="p-2 text-gray-600 hover:text-gray-900 rounded-lg hover:bg-gray-100">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
                <path d="M20 2H4c-1.1 0-1.99.9-1.99 2L2 22l4-4h14c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2zm-2 12H6v-2h12v2zm0-3H6V9h12v2zm0-3H6V6h12v2z"/>
              </svg>
            </Link>

            <Link href="/services" className="p-2 text-gray-600 hover:text-gray-900 rounded-lg hover:bg-gray-100">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
            ...
            <Link href="/policies" className="p-2 text-gray-600 hover:text-gray-900 rounded-lg hover:bg-gray-100">
              <span className="material-icons" style={{ fontSize: '24px' }}>account_balance</span>
            </Link>

            <Link href="/users" className="p-2 text-gray-600 hover:text-gray-900 rounded-lg hover:bg-gray-100">
              <span className="material-icons" style={{ fontSize: '24px' }}>people_alt</span>
            </Link>
          </div>

          <div className="flex items-center gap-4">
            <Link href="/cart" className="p-2 text-gray-600 hover:text-gray-900 rounded-lg hover:bg-gray-100">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
                ...
                <div className="absolute right-0 mt-2 w-80 bg-white rounded-lg shadow-lg border border-gray-200 py-4 z-50">
                  ...
                  {userPolicies.length > 0 && (
                    <div className="px-4 py-3 border-b border-gray-100">
                      ...
                      <div className="space-y-2">
                        {userPolicies.slice(0, 3).map((policy: any) => (
                          <Link
                            key={policy.id}
                  ...
                  {userForums.length > 0 && (
                    <div className="px-4 py-3 border-b border-gray-100">
                      ...
                      <div className="space-y-2">
                        {userForums.slice(0, 3).map((forum: any) => (
                          <Link
                            key={forum.id}
